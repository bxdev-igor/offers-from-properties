...
$templateData = array(
    ...
    'CURRENT_NAME' => $arResult["CURRENT_OFFER"]["NAME"]
);
											...
											<?if($arskuAddToBasketData["ACTION"] !== "NOTHING"):?>
												<?if($arskuAddToBasketData["ACTION"] == "ADD" && $arskuAddToBasketData["CAN_BUY"] && $arParams["SHOW_ONE_CLICK_BUY"]!="N"):?>
													<div class="wrapp-one-click one_click">
														<span class="btn btn-default white one_click custom_1_click" data-item="<?=$arSKU["ID"]?>" data-offers="Y" data-iblockID="<?=$arParams["IBLOCK_ID"]?>" data-quantity="<?=$arskuAddToBasketData["MIN_QUANTITY_BUY"];?>" data-props="<?=$arOfferProps?>" onclick="oneClickBuy('<?=$arSKU["ID"]?>', '<?=$arParams["IBLOCK_ID"]?>', this)">
                    ...
                    <div class="rows_block">
                        ...
                        <?if($isArticle):?>
                            <div class="item_block item_block--article col-<?=$col;?>">
                                <div class="article iblock" itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue" <?if($arResult['SHOW_OFFERS_PROPS']){?> <?}?>>
                                    <span class="block_title" itemprop="name"><?=$arResult["DISPLAY_PROPERTIES"]["CML2_ARTICLE"]["NAME"];?>:</span>
                                    <span class="value" itemprop="value">
                                    <?=($arResult['CURRENT_OFFER']["PROPERTIES"]["CML2_ARTICLE"]["VALUE"])?$arResult['CURRENT_OFFER']["PROPERTIES"]["CML2_ARTICLE"]["VALUE"]:$arResult["DISPLAY_PROPERTIES"]["CML2_ARTICLE"]["VALUE"]?></span>
                                </div>
                            </div>
                        <?endif;?>
                ...
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <?if($totalCount):?>
                                ...
                                <div class="cost prices clearfix">
                                    ...
                                    <?if( count( $arResult["OFFERS"] ) > 0 ){?>
                                        ...
                                        <div class="price_matrix_block" >
                                            <div class="price_matrix_wrapper">
                                                ...
                                                <?if($arResult['CURRENT_OFFER']["CATALOG_PURCHASING_PRICE"]):?>
                                                    <div class="price discount">
                                                    <span class="values_wrapper">
                                                        <span class="price_value"><span class="price_value">
                                                                <?=$arResult['CURRENT_OFFER']["CATALOG_PURCHASING_PRICE"]?>
                                                            </span>
                                                        ...
                                                        <div class="sale_wrapper">
                                                            <?if($arParams["SHOW_DISCOUNT_PERCENT_NUMBER"] != "Y"):?>
                                                                ...
                                                                <div class="text"><span class="values_wrapper">
                                                                    <?=( (int)$arResult['CURRENT_OFFER']["CATALOG_PURCHASING_PRICE"] - (int)$arResult['CURRENT_OFFER']['CATALOG_PRICE_1'])?>
                                                                    ₽
                                                                </span>
                                                                </div>
                                                            <?else:?>
                                    ...
                                    <?}else{?>
                                        ...
                                        <?endif;?>
                                            <?
                                            foreach($arResult['PRICE_MATRIX']['COLS'] as $arPriceGroup) foreach($arResult['PRICE_MATRIX']['MATRIX'][$arPriceGroup['ID']] as $key => &$arPrice) $arPrice['OLD_PRICE'] = $arResult['CATALOG_PURCHASING_PRICE'];
                                            //echo CNext::showPriceMatrix($arResult, $arParams, $strMeasure, $arAddToBasketData);?>

                                            <?echo showPriceMatrix_custom($arResult, $arParams, $strMeasure, $arAddToBasketData);?>
                        ...
                        <div class="buy_block">
                            ...
                            <?if(!$arResult["OFFERS"]):?>
                                ...
                                <div class="counter_wrapp">
                                    ...
                                    <?endif;?>
                                    <div id="<? echo $arItemIDs["ALL_ITEM_IDS"]['BASKET_ACTIONS']; ?>" class="button_block custom_1_click_span <?=(($arAddToBasketData["ACTION"] == "ORDER" /*&& !$arResult["CAN_BUY"]*/) || !$arAddToBasketData["CAN_BUY"] || !$arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_DETAIL"] || ($arAddToBasketData["ACTION"] == "SUBSCRIBE" && $arResult["CATALOG_SUBSCRIBE"] == "Y")  ? "wide" : "");?>">
                                        <!--noindex-->
                            ...
                            <?if($arAddToBasketData["ACTION"] == "ADD" && $arAddToBasketData["CAN_BUY"] && $arParams["SHOW_ONE_CLICK_BUY"]!="N"):?>
                                <div class="wrapp_one_click">
									<span class="btn btn-default white btn-lg type_block transition_bg one_click custom_1_click" data-item="<?=$arResult["ID"]?>" data-iblockID="<?=$arParams["IBLOCK_ID"]?>" data-quantity="<?=$arAddToBasketData["MIN_QUANTITY_BUY"];?>" onclick="oneClickBuy('<?=$arResult["ID"]?>', '<?=$arParams["IBLOCK_ID"]?>', this)">
										<span><?=GetMessage('ONE_CLICK_BUY')?></span>
									</span>
                                </div>
                            <?endif;?>
                            ...
                            <div class="tinkoff-block">
                                ...
                                $payment_params = [
                                    'items.0.name'  	=> ($arResult['CURRENT_OFFER']['NAME']) ? $arResult['CURRENT_OFFER']['NAME'] : $arResult['NAME'],
                                    'items.0.price' 	=> ($arResult['CURRENT_OFFER']['MIN_PRICE']['VALUE']) ? $arResult['CURRENT_OFFER']['MIN_PRICE']['VALUE']:$arResult['MIN_PRICE']['VALUE'],
                                    'items.0.quantity'  => 1,
                                    'sum'				=> ($arResult['CURRENT_OFFER']['MIN_PRICE']['VALUE']) ? $arResult['CURRENT_OFFER']['MIN_PRICE']['VALUE']:$arResult['MIN_PRICE']['VALUE'],
                                    'promoCode' 		=> 'default'
                                ...
                                $ui_params_cr = build_http_query($ui_data_cr);
                                $payment_data = build_http_query($payment_params);
                                ?>
                                <div class='tinkoff_button'>

                                    <tinkoff-create-button
                                            subtext=""
                                            shopId="9cbfd683-6086-4893-a42f-51249cdecb76"
                                            size="M"
                                            showcaseId="38f36884-13a4-435c-8935-21ac919d11c9"
                                            payment-data="<?=$payment_data?>"
                                            Ui-data = <?=$ui_params_cr?>
                                    ></tinkoff-create-button>
                                </div>

                                <? //} ?>

                                <?if(  ($arResult['CURRENT_OFFER']['CATALOG_PURCHASING_PRICE'] > $arResult['CURRENT_OFFER']['VALUE'])
                                    || ($arResult['CATALOG_PURCHASING_PRICE'] > $arResult['MIN_PRICE']['VALUE'])
                                ){?>
                                    <br>
                                    <!--<button
										type="button"
										...
										{
										sum: <?= $arResult['CATALOG_PURCHASING_PRICE']?>,
										items: [{name: '<?= $arResult['NAME']?>', price: <?= $arResult['CATALOG_PURCHASING_PRICE']?>, quantity: 1}],
										demoFlow: 'sms',
                                    ...
                                    $new_params = [
                                        'items.0.name'  	=>  ($arResult['CURRENT_OFFER']['NAME']) ? $arResult['CURRENT_OFFER']['NAME'] : $arResult['NAME'],
                                        'items.0.price' 	=> ($arResult['CURRENT_OFFER']['CATALOG_PURCHASING_PRICE']) ? $arResult['CURRENT_OFFER']['CATALOG_PURCHASING_PRICE']:$arResult['CATALOG_PURCHASING_PRICE'],
                                        'items.0.quantity'  => 1,
                                        'sum'				=> ($arResult['CURRENT_OFFER']['CATALOG_PURCHASING_PRICE']) ? $arResult['CURRENT_OFFER']['CATALOG_PURCHASING_PRICE']:$arResult['CATALOG_PURCHASING_PRICE'],
                                        'promoCode'         => 'installment_0_0_4_5,38'
                                    ...
                                    $ui_params_ras = build_http_query($ui_data_ras);
                                    $payment_data = build_http_query($new_params);
                                    ?>
                        ...
                        <style>
                            ...
                            .tinkoff-wrapper button{
                                display: block;
                                width: 100%;
                            }

                            .tinkoff-wrapper button:not(:first-child){
                                margin-top: 12px;
                            }
                        </style>
                        <?//delivery calculate?>
...
<?if(($arResult["PROPERTIES"][$instr_prop]["VALUE"] && is_array($arResult["PROPERTIES"][$instr_prop]["VALUE"])) || $arResult["SECTION_FULL"]["UF_FILES"]):?>
    <?
    $arFiles = array();
